package id.ac.poliban.mi.ryas.showtoast.homework_042;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) getSupportActionBar().setTitle("Checkboxes and etc_020 RYAS-E020320020/04.3");
    }
