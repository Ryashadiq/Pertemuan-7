package id.ac.poliban.mi.ryas.codingchallenge_043;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) getSupportActionBar().setTitle("Context Menu Scrolling Text_020 RYAS-E020320020");
